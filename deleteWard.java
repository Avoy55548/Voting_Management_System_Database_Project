...
public class deleteWard extends JFrame{
	private Container c;
...
private static void delete(int WARD_NO) {
        try {
            Class.forName("oracle.jdbc.driver.OracleDriver");
            Connection con = DriverManager.getConnection(
                    "jdbc:oracle:thin:@localhost:1521:xe", "system", "1234");
            PreparedStatement stmt = con.prepareStatement("delete from ward where WARD_NO = ?");
