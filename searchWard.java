...
public class searchWard extends JFrame{
	private Container c;
    ...
    searchWard(int x, int y)
	{
		...
		String[] columnNames={"WARD_NO","CENTER_ID","POSTAL_CODE"};
	...
	private void getUser(int WARD_NO) {
        try {
            Class.forName("oracle.jdbc.driver.OracleDriver");
            Connection con = DriverManager.getConnection(
                    "jdbc:oracle:thin:@localhost:1521:xe", "system", "1234");
            PreparedStatement stmt = con.prepareStatement("select * from ward where WARD_NO = ?");
