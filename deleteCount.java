...
public class deleteCount extends JFrame{
	private Container c;
	...
	deleteCount(int x, int y)
	{
		...
		signpButton = new JButton("DELETE");
...
private static void delete(int BALLOT_SERIAL) {
        try {
            Class.forName("oracle.jdbc.driver.OracleDriver");
            Connection con = DriverManager.getConnection(
                    "jdbc:oracle:thin:@localhost:1521:xe", "system", "1234");
            PreparedStatement stmt = con.prepareStatement("delete from vote_count where BALLOT_SERIAL = ?");
