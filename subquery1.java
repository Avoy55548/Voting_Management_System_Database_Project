...
public class subquery1 extends JFrame{
	private Container c;
    ...
    subquery1(int x, int y)
	{
		...
		cancelButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				subquery main = new subquery(x,y);
		...
		String[] columnNames={"VOTER_ID","VOTER_NAME","CANDIDATE_ID"};
	...
	private String[] [] getData1()
	{
		try {
            ...
            ResultSet rs = stmt.executeQuery("select voter_id ,voter_name,candidate_id  from votes where voter_id in (select voter_id from ballot where party_name = 'Awami League' or party_name = 'BNP')");
		 ...
		 String[][] data1 = new String[rowCount][3];
		  ...
		  rs = stmt.executeQuery("select voter_id ,voter_name,candidate_id  from votes where voter_id in (select voter_id from ballot where party_name = 'Awami League' or party_name = 'BNP')"); // Re-execute the query
