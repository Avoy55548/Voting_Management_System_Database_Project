...
public class searchCenter extends JFrame{
	private Container c;
    ...
    searchCenter(int x, int y)
	{
		...
		String[] columnNames={"CENTER_ID","CENTER_NAME"};
	...
	private void getUser(int CENTER_ID) {
        try {
            Class.forName("oracle.jdbc.driver.OracleDriver");
            Connection con = DriverManager.getConnection(
                    "jdbc:oracle:thin:@localhost:1521:xe", "system", "1234");
            PreparedStatement stmt = con.prepareStatement("select * from center where CENTER_ID = ?");
