...
public class outerjoin1 extends JFrame{
	private Container c;
    ...
    outerjoin1(int x, int y)
	{
		...
		String[] columnNames={"VOTER_ID","VOTER_NAME","DOB","CANDIDATE_ID"};
	...
	private String[] [] getData1()
	{
		try {
            ...
            ResultSet rs = stmt.executeQuery("select VOTER_ID,VOTER_NAME,DOB,CANDIDATES.CANDIDATE_ID from votes full join candidates on votes.candidate_id=candidates.candidate_id");
		 ...
		 String[][] data1 = new String[rowCount][4];
		  ...
		  rs = stmt.executeQuery("select VOTER_ID,VOTER_NAME,DOB,CANDIDATES.CANDIDATE_ID from votes full join candidates on votes.candidate_id=candidates.candidate_id"); // Re-execute the query
