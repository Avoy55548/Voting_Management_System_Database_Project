...
public class outerjoin2 extends JFrame{
	private Container c;
	...
	private String[] [] getData1()
	{
		try {
            ...
            ResultSet rs = stmt.executeQuery("select vc.* from vote_count vc, agent_information ai where vc.agent_id(+)=ai.agent_id");
		 ...
		 String[][] data1 = new String[rowCount][4];
		  ...
		  rs = stmt.executeQuery("select vc.* from vote_count vc, agent_information ai where vc.agent_id(+)=ai.agent_id"); // Re-execute the query
