...
public class subquery3 extends JFrame{
	private Container c;
    ...
    subquery3(int x, int y)
	{
		...
		//************************** Table ************************************************
		String[] columnNames={"VOTER_ID","VOTER_NAME","CENTER_ID"};
	...
	private String[] [] getData1()
	{
		try {
            ...
            ResultSet rs = stmt.executeQuery("select voter_id ,voter_name,center_id  from voter where center_id in ( select center_id from ward where ward_no in (1,2,4,6))");
		 ...
		 String[][] data1 = new String[rowCount][3];
		  ...
		  rs = stmt.executeQuery("select voter_id ,voter_name,center_id  from voter where center_id in ( select center_id from ward where ward_no in (1,2,4,6))"); // Re-execute the query
